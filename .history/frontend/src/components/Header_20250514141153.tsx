  ...
  return (
    <div className="bg-[#181818] py-6">
      <div className="container mx-auto flex justify-between">
        <span className="text-3xl text-[#99FFB8] font-bold tracking-tight">
          <Link to="/">Coder With Go Lang</Link>
        </span>
        <span className="flex space-x-2">
          {isLoggedIn ? (
            <>
              <Link
                className="flex items-center text-white transition-all px-3 font-bold hover:bg-[#ff0984]"
                to="/my-bookings"
              >
                My Bookings
              </Link>
